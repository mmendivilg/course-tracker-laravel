...
class FechaFormato
{
     ...
     */
    public function __construct ( $fecha, $formato = null, $locale = null ) {
        if($formato){
            $this->fecha = Carbon::createFromFormat( $formato, $fecha )->locale( $locale ?: 'es' );;
        } else {
            $this->fecha = Carbon::parse($fecha)->locale( $locale ?: 'es' );;
        }
    }
