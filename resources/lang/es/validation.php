    ...
    */
    'fields' => [
        'trabajadores' => [
            ...
            'rfc' => 'RFC',
            'id_capacitacion' => 'Capacitación',
            'aciertos' => 'Aciertos',
            'preguntas' => 'Preguntas',
            'observaciones' => 'Observaciones',
            'id_cat_curso' => 'Curso',
            'id_cat_departamento' => 'Departamento',
            'id_cat_puesto' => 'Puesto',
        ...
        'capacitaciones' => [
            ...
            'id_cat_tipo_capacitacion' => 'Tipo de Capacitación',
            'id_cat_duracion' => 'Duración',
            'id_cliente_empresa' => 'Cliente',
            'registro_stps' => 'Registro STPS'
        ],
        'cursos' => [
            'nombre' => 'Nombre'
        ],
        ...
        'clientes-empresas' => [
            "nombre" => "Nombre",
            "rfc" => "RFC",
            "registro_imss" => "Registro IMSS",
            "contacto" => "Contacto",
            "empresa-giro" => "Actividad o giro principal",
            "calle" => "Calle",
            "numero" => "Numero",
            "codigo_postal" => "CP",
            "ciudad" => "Ciudad",
